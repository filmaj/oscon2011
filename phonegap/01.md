...
* Write your application using HTML, CSS and JavaScript
* "Wrap" it up using the PhoneGap framework
* Your app gets access to device features and data via a JavaScript API
...
* use device APIs that you couldn't otherwise
...
# The PhoneGap Project, continued
